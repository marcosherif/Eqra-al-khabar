...
class DayNightSwitchLocal extends StatefulWidget {
  const DayNightSwitchLocal({
    super.key,
    required this.value,
  ...
  @override
  State<DayNightSwitchLocal> createState() => _DayNightSwitchLocalState();
}

class _DayNightSwitchLocalState extends State<DayNightSwitchLocal>
    with TickerProviderStateMixin, ToggleableStateMixin {
  final _painter = _DayNightSwitchPainter();

  @override
  void didUpdateWidget(covariant DayNightSwitchLocal oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    //wrap whole function with transform scale to control size
...
class _DayNightSwitchPainter extends ToggleablePainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Offset radialReactionOrigin = Offset(
      thumbPaintOffset.dx + _kThumbRadius,
      size.height / 2,
    );
  ...
  void _paintBackground(
    ...
    canvas.drawLine(
      Offset(offset.dx + _kTrackWidth * 0.2, offset.dy + _kTrackHeight * 0.2),
      Offset(
        offset.dx +
            _kTrackWidth * 0.2 +
    ...
    canvas.drawLine(
      Offset(offset.dx + _kTrackWidth * 0.25, offset.dy + _kTrackHeight * 0.8),
      Offset(
        offset.dx +
            _kTrackWidth * 0.25 +
    ...
    canvas.drawLine(
      Offset(offset.dx + _kTrackWidth * 0.1, offset.dy + _kTrackHeight * 0.6),
      Offset(offset.dx + _kTrackWidth * 0.1, offset.dy + _kTrackHeight * 0.6),
      starPaint,
    );
  }
  ...
  void _paintForegroundLines(
    ...
    canvas.drawLine(
      Offset(offset.dx + _kTrackWidth * 0.35, offset.dy + _kTrackHeight * 0.5),
      Offset(
        offset.dx +
            _kTrackWidth * 0.35 +
            (_kTrackWidth * 0.4) * (1 - currentValue),
