import 'package:eqra_el_khabar/features/news_by_category/domain/entities/articles_list.dart';

final mockLatestNewsList = ArticlesList.fromJson({
  "totalResults": 667,
  "articles": [
    {
    ...
    },
    {
      ...
      "title": "Apple Launches 2023 Mac Mini Repair Program Due to Power Issue",
      "description":
